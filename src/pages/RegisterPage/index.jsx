    ...
    <S.RegisterWrapper>
      <div className="register-container">
        ...
        <div>
          <img
            alt="tshirt"
            src="https://ammofficial.com/wp-content/uploads/2022/01/05.-W-OT21W-0002A-Khaki-jacket-da-ve-1000x1500.jpg"
        ...
        <div>
          <img
            alt="tshirt"
            src="https://ammofficial.com/wp-content/uploads/2021/12/AMM-1089.jpg"
            style={{ width: "100%", height: "700px" }}
          />
        </div>
        <div>
          <img
            alt="tshirt"
            src="https://ammofficial.com/wp-content/uploads/2021/11/DSC04492-scaled.jpg"
            style={{ width: "100%", height: "700px" }}
          />
        </div>
        <div>
          <img
            alt="tshirt"
            src="https://ammofficial.com/wp-content/uploads/2021/11/DSC04456-600x900.jpg"
            style={{ width: "100%", height: "700px" }}
          />
        </div>
          </Carousel>
        ...
        <div className="register-right">
          <div className="title-register">
            <S.TextLabel>Clothing Store</S.TextLabel>
          </div>
          <Form
            form={registerForm}
            layout="vertical"
