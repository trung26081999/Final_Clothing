...
import menBanner from "../../../assets/banner/banner4.jpg";
import womenBanner from "../../../assets/banner/banner2.jpg";
...
const ProductPage = () => {
  ...
  useEffect(() => {
    ...
    document.title = `Đồ ${searchObj.gender === "male" ? "Nam" : " Nữ"}`;
    // navigate(
    //   {
  ...
  const renderPageBanner = useMemo(() => {
    return (
      <>
        ...
        <h2>Áo {searchObj.gender === "male" ? "Nam" : "Nữ"}</h2>
    ...
    <S.Wrapper>
      ...
      <S.BreadcrumbWrapper>
        <Breadcrumb separator=">">
          ...
          <Breadcrumb.Item>
            {searchObj.gender === "male" ? <p>Nam</p> : <p>Nữ</p>}
          </Breadcrumb.Item>
        </Breadcrumb>
      </S.BreadcrumbWrapper>
