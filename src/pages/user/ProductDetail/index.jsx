            ...
            <S.ProductInfoWrapper>
              <S.ProductSummary>
                ...
                <p className="product_summary-brand">
                  Sản phẩm: <span>{productDetail.data.category?.name}</span>
                </p>

                <p className="product_summary-gender">
                  Loại sản phẩm:{" "}
                  <Tooltip title={`Tới trang áo ${gender}`}>
                ...
                <p className="product_summary-color">
                  Màu:
                  
                  {productDetail.data?.color?.toLocaleString()}
                </p>
                <p className="product_summary-color">
                  Size:
             
                  {productDetail.data?.caseSize?.toLocaleString()}
